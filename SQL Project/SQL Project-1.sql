...
INSERT INTO album (album_id, title, artist_id) VALUES ('294', 'Great Performances - Barber\'s Adagio and Other Romantic Favorites for Strings', '228');
...
INSERT INTO album (album_id, title, artist_id) VALUES ('339', 'Great Recordings of the Century: Paganini\'s 24 Caprices', '268');
...
INSERT INTO album (album_id, title, artist_id) VALUES ('258', 'House of Pain', '180');
...
INSERT INTO album (album_id, title, artist_id) VALUES ('61', 'Knocking at Your Back Door: The Best Of Deep Purple in the 80\'s', '58');
...
INSERT INTO album (album_id, title, artist_id) VALUES ('340', 'Liszt - 12 Ãtudes D\'Execution Transcendante', '269');
...
INSERT INTO album (album_id, title, artist_id) VALUES ('207', 'Mezmerize', '135');
...
INSERT INTO album (album_id, title, artist_id) VALUES ('293', 'Pavarotti\'s Opera Made Easy', '227');
...
INSERT INTO album (album_id, title, artist_id) VALUES ('86', 'Quanta Gente Veio Ver (Live)', '27');
...
INSERT INTO album (album_id, title, artist_id) VALUES ('344', 'Schubert: The Late String Quartets & String Quintet (3 CD\'s)', '272');
...
INSERT INTO album (album_id, title, artist_id) VALUES ('147', 'The Best Of Men At Work', '105');
...
INSERT INTO album (album_id, title, artist_id) VALUES ('67', 'Vault: Def Leppard\'s Greatest Hits', '78');
...
select * from customer;
select * from invoice;
-- used joins here to find the top 1 person 
...
SELECT 
  ...
  g.name
FROM customer a
JOIN invoice i ON i.customer_id = a.customer_id
...
SELECT ar.name as Artist,count(t.name) as Track_count ,max(g.name) AS genre_count FROM artist ar
...
order by milliseconds desc,name asc
LIMIT 100;
